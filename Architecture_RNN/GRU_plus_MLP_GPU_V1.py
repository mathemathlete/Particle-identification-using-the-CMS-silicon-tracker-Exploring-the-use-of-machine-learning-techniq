...
class ParticleDataset_V1(Dataset):
    """
...
if __name__ == "__main__":
    ...
    dataset = ParticleDataset_V1(ndedx_values_train, dedx_values, data_th_values,p_values_train,eta_values_train,Ih_values_train)
    ...
    test_dataset = ParticleDataset_V1(ndedx_values_test,dedx_values_test, data_th_values_test,p_values_test,eta_values_test,Ih_values_test)
