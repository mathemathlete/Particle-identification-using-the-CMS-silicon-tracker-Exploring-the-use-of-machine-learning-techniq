...
test_dataset_rnn = rnn.ParticleDataset(ndedx_values_train, dedx_value_train, data_th_values,p_values_train,eta_values_train,Ih_values_train)
test_dataset_rnn2 = rnn2.ParticleDataset_V2a(ndedx_values_train, dedx_value_train, data_th_values,eta_values_train,Ih_values_train)
test_dataset_rnn3 = rnn3.ParticleDataset_V2b(ndedx_values_train, dedx_value_train, data_th_values,eta_values_train)
test_dataset_rnn4 = rnn4.ParticleDataset_V3(ndedx_values_train, dedx_value_train, dx_values_train,modulegeom_values_train, data_th_values, eta_values_train, Ih_values_train)
test_dataset_rnn5 = rnn5.ParticleDataset_V1(ndedx_values_train, dedx_value_train, data_th_values,p_values_train,eta_values_train,Ih_values_train)
test_dataset_rnn6 = rnn6.ParticleDataset_V2a(ndedx_values_train, dedx_value_train, data_th_values,eta_values_train,Ih_values_train)
test_dataset_rnn7 = rnn7.ParticleDataset_V2b(ndedx_values_train, dedx_value_train, data_th_values,eta_values_train)
test_dataset_rnn8 = rnn8.ParticleDataset_V3(ndedx_values_train, dedx_value_train, dx_values_train,modulegeom_values_train, data_th_values, eta_values_train, Ih_values_train)
...
data_plot['track_p']=test_dataset_rnn["track_p"].to_list()
